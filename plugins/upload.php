...
.container nav a
{
    border-bottom: 2px solid #e5f9ff;
...
<div class="box__input">
    ...
    <input type="file" style="visibility:hidden;" name="files[]" id="file" class="box__file" data-multiple-caption="{count} files selected" multiple="">
    <label for="file"><strong class="text_over_hover">Choose a file</strong><span class="box__dragndrop"> or drag it here</span>.</label>
